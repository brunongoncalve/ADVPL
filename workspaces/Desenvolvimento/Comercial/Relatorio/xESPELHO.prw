...
USER FUNCTION xESPELHO()
    ...
    cTextHtml += " O MESMO SERÁ CANCELADO.A NF DE DEVOLUÇÃO DEVERÁ SER ENVIADA PARA CONFERÊNCIA DA ALUMBRA NO PRAZO DE 12 HORAS APÓS A SUA EMISSÃO, UMA VEZ QUE SE " + CRLF
    cTextHtml += " FOR NECESSÁRIO O CANCELAMENTO DA MESMA, O CLIENTE TERÁ O PRAZO DE 24HORAS. " + CRLF
