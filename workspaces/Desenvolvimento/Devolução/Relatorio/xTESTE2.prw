        ...
        oPrinter:SAY(318,470,"VL ICMS",oFont1)
            ...
            WHILE (cAlias1)->(!Eof())
                FOR nI := 1 TO LEN(cAlias)
                    oPrinter:SAY(nVert,10,(cAlias1)->ZZY_PROD,oFont1)
                    oPrinter:SAY(nVert,40,(cAlias1)->B1_DESC,oFont1)
                    oPrinter:SAY(nVert,190,(cAlias1)->B1_POSIPI,oFont1)
                    oPrinter:SAY(nVert,235,(cAlias1)->ZA2_CFOPIM,oFont1)
                    oPrinter:SAY(nVert,260,(cAlias1)->D2_UM,oFont1)
                    oPrinter:SAY(nVert,264,STR((cAlias1)->ZZY_QTD,6),oFont1)
                    oPrinter:SAY(nVert,280,STR((cAlias1)->D2_PRCVEN,10,2),oFont1)
                    oPrinter:SAY(nVert,320,STR((cAlias1)->D2_TOTAL,10,2),oFont1)
                    oPrinter:SAY(nVert,370,STR((cAlias1)->D2_BASEICM),oFont1)
                    oPrinter:SAY(nVert,460,STR((cAlias1)->D2_VALICM,10,2),oFont1)
                    nVert += 10
                NEXT
            (cAlias1)->(DBSKIP())    
            ENDDO
