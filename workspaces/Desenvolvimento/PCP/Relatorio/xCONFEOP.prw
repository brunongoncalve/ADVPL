...
STATIC FUNCTION REPORTDEF(MV_PAR01,MV_PAR02,MV_PAR03,MV_PAR04,MV_PAR05)
    ...
    TRCELL():NEW(oSection1,"C2_OP",cAliasOP,"COD.CLI",,nSize,,{|| (cAliasOP)->C2_OP},cAlign,lLineBreak,cHeaderAlign,,nColSpace,lAutoSize)
    TRCELL():NEW(oSection1,"C2_OP",cAliasOP,"CLIENTE",,nSize,,{|| (cAliasOP)->C2_OP},cAlign,lLineBreak,cHeaderAlign,,nColSpace,lAutoSize)
...
STATIC FUNCTION REPORTPRINT(oReport,cAliasOP,MV_PAR01,MV_PAR02,MV_PAR03,MV_PAR04,MV_PAR05)
    ...
    cQuery += " WHERE T.C2_OP BETWEEN '"+MV_PAR03+"' AND '"+MV_PAR04+"' AND T.PERIODO >= '"+MV_PAR04+"' AND T.PROD_PAI BETWEEN '"+MV_PAR01+"' AND '"+MV_PAR02+"' " + CRLF
